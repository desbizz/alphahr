...
module.exports = "<form #f=\"ngForm\" (ngSubmit)=\"submit()\">\n    <div class=\"form-group row\">\n      <label for=\"banknName\" class=\"col-sm-2 col-form-label\">Configuration Name</label>\n      <div class=\"col-sm-10\">\n        <input type=\"text\"  class=\"form-control\" id=\"name\" name=\"name\" [(ngModel)]=\"config.name\" placeholder=\"name\">\n      </div>\n    </div>\n    <div class=\"form-group row\">\n      <label for=\"accountNumber\" class=\"col-sm-2 col-form-label\">Name</label>\n      <div class=\"col-sm-10\">\n        <input type=\"text\" class=\"form-control\" id=\"value\" name=\"value\" [(ngModel)]=\"config.value\" placeholder=\"\">\n      </div>\n    </div>\n   \n            \n                          <button>Save</button>\n  </form>"
        ...
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_4__["NgModule"])({
            ...
            imports: [
                ...
                _angular_router__WEBPACK_IMPORTED_MODULE_7__["RouterModule"].forRoot([
                    ...
                    { path: 'addconfig', component: src_components_config_form_config_form_component__WEBPACK_IMPORTED_MODULE_17__["ConfigFormComponent"] },
...
var ConfigFormComponent = /** @class */ (function () {
    function ConfigFormComponent(individual, toastr, configService) {
        this.individual = individual;
        this.toastr = toastr;
    ...
    ConfigFormComponent.prototype.submit = function () {
        if (this.config._id) {
            this.configService.UpdateConfig(this.config).subscribe(function (x) {
            });
    ...
    ConfigFormComponent = __decorate([
        ...
        __metadata("design:paramtypes", [src_app_app_component__WEBPACK_IMPORTED_MODULE_1__["AppComponent"], ngx_toastr__WEBPACK_IMPORTED_MODULE_2__["ToastrService"], src_services_configurations_service__WEBPACK_IMPORTED_MODULE_3__["ConfigurationsService"]])
    ], ConfigFormComponent);
...
var ConfigPageComponent = /** @class */ (function () {
    function ConfigPageComponent(individual, toastr, individualService) {
        this.individual = individual;
        this.toastr = toastr;
        this.individualService = individualService;
        this.account = {};
...
module.exports = __webpack_require__(/*! C:\cloud\Alphahr\src\main.ts */"./src/main.ts");
